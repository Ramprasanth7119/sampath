  ...
  return (
    <div className="app">
      ...
      <section className="card-grid">
        <div className="card large" style={{ backgroundImage: 'url(../assets/images/img1.jpeg)' }}>
        ...
        <div className="card large" style={{ backgroundImage: ' url(../assets/images/img2.jpeg)' }}>
          <div className="card-content">
            <h3>Every point perfect</h3>
            <p>Create anything from icons to entire apps with a vector editor like no other.</p>
          </div>
        </div>
        <div className="card small" style={{ backgroundImage: 'url(../assets/images/img3.avif)' }}>
          <div className="card-content">
            <h3>Work effortlessly</h3>
            <p>Easy multi-layer renaming, a Canvas Minimap, and Command Bar put your workflow on rails.</p>
          </div>
        </div>
        <div className="card small" style={{ backgroundImage: 'url(../assets/images/img5.jpeg)' }}>
          <div className="card-content">
        ...
        <div className="card large" style={{ backgroundImage: 'url(../assets/images/img7.jpeg)' }}>
          <div className="card-content">
            <h3>Ready to scale</h3>
            <p>Reuse elements across your designs. Update once and watch your changes roll out everywhere.</p>
          </div>
        </div>
        <div className="card large" style={{ backgroundImage: 'url(../assets/images/img8.webp)' }}>
          <div className="card-content">
            <h3>Zero to done</h3>
